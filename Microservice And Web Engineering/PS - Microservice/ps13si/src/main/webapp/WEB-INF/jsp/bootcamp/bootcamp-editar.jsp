...
<title>PS13SI - Editar Bootcamp</title>
				...
				<div class="collapse navbar-collapse justify-content-md-end"
					...
					<ul class=" navbar-nav nav ">
						...
						<li class="nav-item"><a class="nav-link active  text-danger"
							href="${contextPath}/bootcamps">Bootcamps</a></li>
	...
	<section>
		...
		<main class="container my-5">
			...
			<div class="bg-dark p-5 rounded">
				...
				<h1 class="text-center text-light">Revise os dados</h1>

				<form:form modelAttribute="bootcampModel"
					action="${contextPath}/bootcamp/${bootcampModel.id_bootcamp}"
					method="put">
