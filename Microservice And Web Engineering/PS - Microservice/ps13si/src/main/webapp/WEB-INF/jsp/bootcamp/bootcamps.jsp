...
<title>PS13SI - Lista de Bootcamps</title>
...
<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse justify-content-md-end"
					...
					<ul class=" navbar-nav nav ">
						...
						<li class="nav-item"><a class="nav-link text-muted"
							href="${contextPath}/login" tabindex="-1" aria-disabled="true">Sair</a></li>
	...
	<section class="">
		...
		<h1 class="text-center  my-3">LISTA DE BOOTCAMPS</h1>

		<div class="table-responsive mx-5">

			<div>

				<a href="${contextPath}/bootcamp/form?page=bootcamp-novo">
			...
			<c:choose>
				<c:when test="${empty bootcamps}">
					<div class="alert alert-danger d-flex align-items-center my-5"
						...
						<div>Não há bootcamps cadastrados!</div>
					</div>
					<br>
					<br>
				</c:when>
					...
					<table class="table table-dark table-striped my-2">
						...
						<thead>
							...
							<tr>
								...
								<th scope="col">Nome do Bootcamp</th>
								<th scope="col">Empresa</th>
								<th scope="col">Número de Participantes</th>
								<th scope="col">Preço por Pessoa (R$)</th>
						...
						<tbody>
							...
							<c:forEach items="${bootcamps}" var="bootcamp">
								...
								<tr>
									...
									<!-- NOME    -->
									<td>${bootcamp.nome_bootcamp}</td>

									<!-- Empresa -->
									<td>${bootcamp.empresa_bootcamp}</td>

									<!-- Participantes -->
									<td>${bootcamp.num_participantes_bootcamp}</td>

									<!-- PreÃ§o por pessoa -->
									<td>${bootcamp.preco_bootcamp}</td>

									<!-- ABRE MENU -->
									<td class="col"><form:form
											action="${contextPath}/bootcamp/${bootcamp.id_bootcamp}"
											method="delete">

											<!-- LINKAR BOTAO AQUI: -->
											<a href="${contextPath}/bootcamp/${bootcamp.id_bootcamp}">
                                ...
                                <path
											...
											<!-- LINKAR BOTAO AQUI: -->
											<a
												href="${contextPath}/bootcamp/form?page=bootcamp-editar&id=${bootcamp.id_bootcamp}">
